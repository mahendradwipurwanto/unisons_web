                ...
                <div class="container">
                    <div class="header-row">
                        ...
                        <div id="logo" class="mx-auto border-0 px-0">
                            <a href="index.html" class="standard-logo" data-dark-logo="<?= base_url(); ?>assets/images/logo-dark.png"><img src="images/logo.png" alt="Canvas Logo"></a>
                            <a href="index.html" class="retina-logo" data-dark-logo="<?= base_url(); ?>assets/images/logo-dark@2x.png"><img src="images/logo@2x.png" alt="Canvas Logo"></a>
                        </div><!-- #logo end -->
